...
CSupportVectorMachineClassifier::CSupportVectorMachineClassifier()
{
...
CSupportVectorMachineClassifier::CSupportVectorMachineClassifier(SVMINFO *svmi)
{
...
void CSupportVectorMachineClassifier::SetSupportVectorMachineInfo (SVMINFO *svmi){
...
void CSupportVectorMachineClassifier::LabelDataSet (CDataSet *pDataSet){

	int i;

	for (i=0;i<pDataSet->GetClass(0)->GetNumberOfPatterns();i++){
		pDataSet->GetClass(0)->GetPattern(i)->SetReservedValue(1);
	}
	
	for (i=0;i<pDataSet->GetClass(1)->GetNumberOfPatterns();i++){
		pDataSet->GetClass(1)->GetPattern(i)->SetReservedValue(-1);
	}

}

void CSupportVectorMachineClassifier::Classify (CDataSet *pDataSet, CPattern *pUnknownPattern){
	...
	CClass *CombinedClass = pDataSet->MergeDataSet();
	...
	if ((pUnknownPattern->GetReservedValue() > 0) && (dblDiscriminant > 0)){
		if (pUnknownPattern->GetReservedValue() > 0){
			SetClassifierOutput(0);
		}
		else{
			SetClassifierOutput(1);
		}
	}
...
CDataMatrix1D *CSupportVectorMachineClassifier::DesignSupportVectorMachineClassifier (CDataMatrix2D *CombinedDataSetMatrix, CDataMatrix1D *LabelMatrix, CDataMatrix1D *LagrangianMatrix){
...
int CSupportVectorMachineClassifier::ExamineExample (CDataMatrix2D *CombinedDataSetMatrix, CDataMatrix1D *LabelMatrix, int iRowIndex){
...
int CSupportVectorMachineClassifier::TakeStep (CDataMatrix2D *CombinedDataSetMatrix, CDataMatrix1D *LabelMatrix, int iIndex1, int iIndex2){
...
int CSupportVectorMachineClassifier::FindMinError (int iNumberOfPatterns){
...
int CSupportVectorMachineClassifier::FindMaxError (int iNumberOfPatterns){
...
void CSupportVectorMachineClassifier::RandomSwap (int* A, int n){
...
double CSupportVectorMachineClassifier::CalculateLinearKernelValue (double *x1, double *x2, int d){
...
double CSupportVectorMachineClassifier::CalculateGaussianKernelValue (double *x1, double *x2, int d){
...
double CSupportVectorMachineClassifier::CalculatePolynomialKernelValue (double *x1, double *x2, int d){
...
double CSupportVectorMachineClassifier::CalculateSigmoidKernelValue (double *x1, double *x2, int d){
...
double CSupportVectorMachineClassifier::CalculateRadialBasisFunctionKernelValue (double *x1, double *x2, int d){
